...
function FormSubmitData(url,id) {
	
	var fd = new FormData(document.getElementById('f_'+id));
	$.ajax({
	  url: url,
	  type: 'POST',
	  data: fd,
	  ...
	  contentType: false   // tell jQuery not to set contentType
	   ...
	   $('#response_testapi_'+id).html('<pre>'+data+'<pre>');
	});
	return false;
}
/*!
